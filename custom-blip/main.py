...
from custom_datasets.flickr30kcombined import Flickr30kDatasetCombined
...
def main():
    ...
    full_dataset = Flickr30kDatasetCombined(root_dir=args.root_dir, annotations_file=args.annotations_file, processor=processor)
